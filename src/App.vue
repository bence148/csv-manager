        ...
        <div class="px-6 mx-auto max-w-7xl lg:px-8">
          <div class="max-w-2xl mx-auto mb-20 text-center">
            ...
            <div class="flex items-center justify-center mt-10 gap-x-6">
              <label
                for="fileInput"
                class="rounded-md cursor-pointer bg-primary px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-[#3FB883]/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
              >
                Importieren
