            ...
            <span class="flex justify-end w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
              <div class="flex justify-end my-4">
                <button
                  @click="save"
                  type="button"
                  class="block px-3 mr-1 text-sm font-semibold text-center text-white bg-primary rounded-md shadow-sm hover:bg-[#3FB883]/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
                >
